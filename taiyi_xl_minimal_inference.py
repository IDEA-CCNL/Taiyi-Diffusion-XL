...
# from library.load_test_dataset import load_test_dataset
...
def generate_image(prompt, prompt2, negative_prompt, seed=None):
    ...
    print("text_embedding和vector_embeddings的shape",text_embeddings.shape, vector_embeddings.shape)
    ...
    with torch.no_grad():
        for i, t in enumerate(tqdm(timesteps)):
            ...
            print("unet shape check:", latent_model_input.shape, f"{t}/{timesteps}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", type=str, default="/cognitive_comp/zhangdixiang/checkpoints/taiyi-diffusion-xl-base-1.0-text_encoder_pretrained/unsplash_all_reduce_1024-000005.safetensors")
    parser.add_argument("--prompt", type=str, default="A photo of a cat")
    parser.add_argument("--prompt2", type=str, default=None)
    parser.add_argument("--negative_prompt", type=str, default="广告, ，, ！, 。, ；, 资讯, 新闻, 水印")
    parser.add_argument("--output_dir", type=str, default="/cognitive_comp/wuxiaojun/github/taiyi-diffusion/outputs")
    parser.add_argument(
        "--lora_weights",
        type=str,
        nargs="*",
    ...
    args.ckpt_path = "./outputs/catwoman_1024/catwoman_1024.safetensors"

    # HuggingFaceのmodel id
    PRETRAINED_MODEL_DIR = "/cognitive_comp/wuxiaojun/pretrained/Taiyi-Stable-Diffusion-XL-3.5B/"
    ...
    # tokenizer2 = lambda x: open_clip.tokenize(x, context_length=512)
    ...
    prompt = "very beautiful catwoman with black hair and yellow eyes"
    prompt = "一个美丽的猫女，有着黄色眼睛和黑色头发"
