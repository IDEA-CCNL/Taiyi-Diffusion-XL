...
def load_tokenizers(args: argparse.Namespace):
    ...
    if os.path.isfile(args.pretrained_model_name_or_path):
        ckpt_dir= os.path.dirname(os.path.abspath(args.pretrained_model_name_or_path))
        TOKENIZER1_PATH = os.path.join(ckpt_dir, "tokenizer")
        TOKENIZER2_PATH = os.path.join(ckpt_dir, "tokenizer_2")
    else:
        TOKENIZER1_PATH = os.path.join(args.pretrained_model_name_or_path, "tokenizer")
        TOKENIZER2_PATH = os.path.join(args.pretrained_model_name_or_path, "tokenizer_2")
