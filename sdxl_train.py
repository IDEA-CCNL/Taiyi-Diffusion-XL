...
def train(args):
                            ...
                            "subsets": [
                                {
                                    ...
                                    "latents_dir": args.latents_data_dir,
    ...
    # モデルを読み込む
    model_version = "sdxl" if not args.taiyi else "taiyi"
    (
        ...
        logit_scale,
        ckpt_info,
    ) = sdxl_train_util.load_target_model(args, accelerator, model_version, weight_dtype)
            ...
            with accelerator.accumulate(*training_models):
                ...
                if "text_encoder_outputs1_list" not in batch or batch["text_encoder_outputs1_list"] is None:
                    ...
                    with torch.set_grad_enabled(args.train_text_encoder):
                        ...
                        # else:
                        if args.taiyi:
                            encoder_hidden_states1, encoder_hidden_states2, pool2 = train_util.get_hidden_states_taiyixl(
